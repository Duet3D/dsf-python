...
class Board(ModelObject):
    ...
    def __init__(self) -> None:
        ...
        # Accelerometer of this board or None if unknown
        self._accelerometer: Optional[Accelerometer] = None
        # Filename of the bootloader binary or None if unknown
        self._bootloader_file_name: Optional[str] = None
        # CAN address of this board or None if not applicable
        self._can_address: Optional[int] = None
        # Closed loop data of this board or None if unknown
        self._closed_loop: Optional[BoardClosedLoop] = None
        # Details about a connected display or None if none is connected
        self._direct_display: Optional[DirectDisplay] = None
        # Drivers of this board
        self._drivers: Optional[ModelCollection[Driver]] = None
        # Date of the firmware build
        self._firmware_date: str = ""
        # Filename of the firmware binary
        self._firmware_file_name: str = ""
    ...
    def bootloader_file_name(self, value: Optional[str]):
    ...
    @can_address.setter
    def can_address(self, value: Optional[int | str]):
        self._can_address = int(value) if value is not None else None

    @property
    def drivers(self) -> Optional[Sequence[Optional[Driver]]]:
        """Drivers of this board"""
        return self._drivers

    @drivers.setter
    def drivers(self, value: Optional[Iterable[object]]):
        self._drivers = None if value is None else ModelCollection(Driver, list(value))
    ...
    @free_ram.setter
    def free_ram(self, value: Optional[int | str]):
    ...
    def iap_file_name_SBC(self, value: Optional[str]):
    ...
    def iap_file_name_SD(self, value: Optional[str]):
    ...
    @max_heaters.setter
    def max_heaters(self, value: int | str):
    ...
    @max_motors.setter
    def max_motors(self, value: int | str):
    ...
    @state.setter
    def state(self, value: Optional[BoardState | str]):
        if value is None:
            self._state = BoardState.unknown
        elif isinstance(value, BoardState):
            self._state = value
    ...
    def supports_12864(self, value: bool | int | str):
    ...
    def supports_direct_display(self, value: bool | int | str):
    ...
    @unique_id.setter
    def unique_id(self, value: Optional[str]):
        self._unique_id = str(value) if value is not None else None

    @property
    def wifi_firmware_file_name(self) -> Optional[str]:
        """Filename of the on-board WiFi chip or None if not present"""
        return self._wifi_firmware_file_name

    @wifi_firmware_file_name.setter
    def wifi_firmware_file_name(self, value: Optional[str]):
