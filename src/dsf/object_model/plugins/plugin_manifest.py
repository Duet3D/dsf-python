...
class PluginManifest(ModelObject):
    ...
    def __init__(self):
        ...
        self._id: str = ""
        self._license: str = "LGPL-3.0-or-later"
        self._name: str = ""
        self._rrf_version: Union[str, None] = None
        self._sbc_auto_restart: bool = False
        ...
        self._sbc_package_dependencies: List[str] = []
        # Use a list instead of a set to keep insertion order (useful for json serialising)
    ...
    @dwc_version.setter
    def dwc_version(self, value: Union[str, None]):
    ...
    @sbc_notify_started.setter
    def sbc_notify_started(self, value: bool):
