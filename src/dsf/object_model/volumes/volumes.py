...
class Volume(ModelObject):
    ...
    @capacity.setter
    def capacity(self, value: int | str | None):
    ...
    @free_space.setter
    def free_space(self, value: int | str | None):
    ...
    @mounted.setter
    def mounted(self, value: bool | int | str):
    ...
    @open_files.setter
    def open_files(self, value: int | str | None):
    ...
    def partition_size(self, value: int | str | None):
