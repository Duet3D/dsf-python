...
class Limits(ModelObject):
    ...
    @axes.setter
    def axes(self, value: int | str | None):
    ...
    def axes_plus_extruders(self, value: int | str | None):
    ...
    @bed_heaters.setter
    def bed_heaters(self, value: int | str | None):
    ...
    @boards.setter
    def boards(self, value: int | str | None):
    ...
    def chamber_heaters(self, value: int | str | None):
    ...
    @drivers.setter
    def drivers(self, value: int | str | None):
    ...
    def drivers_per_axis(self, value: int | str | None):
    ...
    @extruders.setter
    def extruders(self, value: int | str | None):
    ...
    def extruders_per_tool(self, value: int | str | None):
    ...
    @fans.setter
    def fans(self, value: int | str | None):
    ...
    @gp_in_ports.setter
    def gp_in_ports(self, value: int | str | None):
    ...
    @gp_out_ports.setter
    def gp_out_ports(self, value: int | str | None):
    ...
    @heaters.setter
    def heaters(self, value: int | str | None):
    ...
    def heaters_per_tool(self, value: int | str | None):
        self._heaters_per_tool = int(value) if value is not None else None

    @property
    def led_strips(self) -> int | None:
        """Maximum number of configured LED strips or null if unknown"""
        return self._led_strips

    @led_strips.setter
    def led_strips(self, value: int | str | None):
    ...
    def monitors_per_heater(self, value: int | str | None):
        self._monitors_per_heater = int(value) if value is not None else None

    @property
    def ports_per_heater(self) -> int | None:
        """Maximum number of output ports per heater or null if unknown"""
        return self._ports_per_heater

    @ports_per_heater.setter
    def ports_per_heater(self, value: int | str | None):
    ...
    def restore_points(self, value: int | str | None):
    ...
    @sensors.setter
    def sensors(self, value: int | str | None):
    ...
    @spindles.setter
    def spindles(self, value: int | str | None):
    ...
    @tools.setter
    def tools(self, value: int | str | None):
    ...
    def tracked_objects(self, value: int | str | None):
    ...
    @triggers.setter
    def triggers(self, value: int | str | None):
    ...
    @volumes.setter
    def volumes(self, value: int | str | None):
    ...
    @workplaces.setter
    def workplaces(self, value: int | str | None):
    ...
    def z_probe_program_bytes(self, value: int | str | None):
    ...
    @z_probes.setter
    def z_probes(self, value: int | str | None):
