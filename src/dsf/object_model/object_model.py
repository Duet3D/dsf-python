...
class ObjectModel(ModelObject):
    ...
    @property
    def boards(self) -> Sequence[Board | None]:
    ...
    @property
    def fans(self) -> Sequence[Fan | None]:
    ...
    @property
    def led_strips(self) -> Sequence[LedStrip | None]:
    ...
    @property
    def messages(self) -> Sequence[Message | None]:
    ...
    @property
    def spindles(self) -> Sequence[Spindle | None]:
